...
import SocialProofNudge from './BehavioralInterventions/SocialProofNudge';
import DefaultAmountNudge from './BehavioralInterventions/DefaultAmountNudge';
import ImpactFeedback from './BehavioralInterventions/ImpactFeedback';
import ProgressBar from './BehavioralInterventions/ProgressBar';

const DonationFormExperimental = ({ variant, logEvent, logDonationEvent, completeDonation }) => {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <button
            ...
            className={`w-full py-3 px-4 rounded-lg font-semibold text-white transition ${isProcessing || donationAmount <= 0 ? 'bg-gray-400 cursor-not-allowed' : 'bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700'}`}
          >
            {isProcessing ? (
...
export default DonationFormExperimental;
