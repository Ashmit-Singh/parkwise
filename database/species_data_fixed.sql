...
CREATE TABLE species (
    ...
    description TEXT,
    habitat_type TEXT,  -- Changed from 'habitat' to 'habitat_type'
...
SELECT common_name, conservation_status, category FROM species ORDER BY conservation_status, common_name;
