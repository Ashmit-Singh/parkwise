...
-- Fixed to match existing table structure
...
CREATE TABLE campaigns (
    ...
    supporter_count INTEGER DEFAULT 0,  -- Changed from 'donors' to 'supporter_count'
    start_date DATE,
    end_date DATE,
...
-- Insert Conservation Campaigns with correct column names
...
SELECT title, status, current_amount, target_amount, supporter_count FROM campaigns ORDER BY status, created_at DESC;
